...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class XRKnob3 : XRBaseInteractable
    {
        ...
        void UpdateWaterLevel()
        {
            ...
            newYScale = Mathf.Lerp(0f, 0.7f, (m_Value - 0.5f) * 2);
            if (newYScale >= 0.6f)
            {
                missionSuccess = true;
                MissionSuccess();
                newYScale = 0.6f; // Ensure the water level is fixed at 1
            }
        ...
        {
            Debug.Log("미션 성공! 물탱크가 채워졌습니다.");
            // 추가적인 미션 성공 처리 (예: UI 표시, 다음 단계로 진행 등)
        }
